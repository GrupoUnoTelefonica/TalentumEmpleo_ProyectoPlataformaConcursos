...
import com.telefonica.plataformaconcursos.NoSuchUsuarioException;
import com.telefonica.plataformaconcursos.model.Usuario;
import com.telefonica.plataformaconcursos.model.impl.UsuarioImpl;
import com.telefonica.plataformaconcursos.model.impl.UsuarioModelImpl;
...
public class UsuarioPersistenceImpl extends BasePersistenceImpl<Usuario>
    ...
    protected Usuario toUnwrappedModel(Usuario usuario) {
        ...
        usuarioImpl.setApellidos(usuario.getApellidos());
        usuarioImpl.setCorreoElectronico(usuario.getCorreoElectronico());
        usuarioImpl.setPassword1(usuario.getPassword1());
        usuarioImpl.setPassword2(usuario.getPassword2());
        usuarioImpl.setDocumento(usuario.getDocumento());
        usuarioImpl.setPuntuacionObtenida(usuario.getPuntuacionObtenida());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.telefonica.plataformaconcursos.model.Usuario")));
