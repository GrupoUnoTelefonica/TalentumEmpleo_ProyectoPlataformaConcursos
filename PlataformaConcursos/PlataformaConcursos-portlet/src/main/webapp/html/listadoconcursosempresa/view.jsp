...
<%List<Concurso> concursos = (List<Concurso>)request.getAttribute("listaConcursos");

 %>

<h1>Mis Concursos publicados<h1>
...
<table>
	<thead>
  		<tr>
    		...
    		<th><h4>Usuarios Inscritos</h4></th>
  		</tr>
 	 </thead>
 	 <tbody>
 	 ...
 	 <portlet:actionURL var="usuariosInscritosAConcursoUrl" name="usuariosInscritosAConcurso">
 	  ...
 	  <tr>
    	...
    	<td><h6><a href="<%=usuariosInscritosAConcursoUrl %>" >Más información</a></h6>
 	 </tr>
 	 </c:forEach>
 	 </tbody>
