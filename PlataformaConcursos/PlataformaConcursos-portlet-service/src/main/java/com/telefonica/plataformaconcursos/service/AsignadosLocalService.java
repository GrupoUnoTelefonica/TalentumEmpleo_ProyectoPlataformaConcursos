...
/**
 * Provides the local service interface for Asignados. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AsignadosLocalServiceUtil
...
public interface AsignadosLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AsignadosLocalServiceUtil} to access the asignados local service. Add custom service methods to {@link com.telefonica.plataformaconcursos.service.impl.AsignadosLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
