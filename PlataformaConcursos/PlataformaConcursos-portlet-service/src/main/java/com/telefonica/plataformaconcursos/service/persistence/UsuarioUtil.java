...
public class UsuarioUtil {
    ...
    */
    public static void cacheResult(
        java.util.List<com.telefonica.plataformaconcursos.model.Usuario> usuarios) {
    ...
    */
    public static com.telefonica.plataformaconcursos.model.Usuario create(
        long usuarioId) {
    ...
    * @throws com.telefonica.plataformaconcursos.NoSuchUsuarioException if a usuario with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static com.telefonica.plataformaconcursos.model.Usuario remove(
        long usuarioId)
    ...
    public static com.telefonica.plataformaconcursos.model.Usuario updateImpl(
        com.telefonica.plataformaconcursos.model.Usuario usuario)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    /**
    * Returns the usuario with the primary key or throws a {@link com.telefonica.plataformaconcursos.NoSuchUsuarioException} if it could not be found.
    *
    * @param usuarioId the primary key of the usuario
    * @return the usuario
    * @throws com.telefonica.plataformaconcursos.NoSuchUsuarioException if a usuario with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static com.telefonica.plataformaconcursos.model.Usuario findByPrimaryKey(
        long usuarioId)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.telefonica.plataformaconcursos.NoSuchUsuarioException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.telefonica.plataformaconcursos.model.Usuario fetchByPrimaryKey(
        long usuarioId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.telefonica.plataformaconcursos.model.Usuario> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static UsuarioPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (UsuarioPersistence) PortletBeanLocatorUtil.locate(com.telefonica.plataformaconcursos.service.ClpSerializer.getServletContextName(),
