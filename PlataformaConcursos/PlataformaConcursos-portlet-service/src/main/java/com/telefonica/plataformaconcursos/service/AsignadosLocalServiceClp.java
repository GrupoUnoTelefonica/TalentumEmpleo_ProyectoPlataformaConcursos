 ...
 * @generated
 */
public class AsignadosLocalServiceClp implements AsignadosLocalService {
    ...
    public AsignadosLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "findByUsuarioId";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "findByConcursoId";
    ...
    public com.telefonica.plataformaconcursos.model.Asignados addAsignados(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(asignados) });
        } catch (Throwable t) {
        ...
        return (com.telefonica.plataformaconcursos.model.Asignados) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.telefonica.plataformaconcursos.model.Asignados createAsignados(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(asignadosId) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.plataformaconcursos.model.Asignados> getAsignadoses(
        ...
        return (java.util.List<com.telefonica.plataformaconcursos.model.Asignados>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.telefonica.plataformaconcursos.model.Asignados> findByUsuarioId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { usuarioId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.plataformaconcursos.model.Asignados> findByConcursoId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    _methodParameterTypes20, new Object[] { concursoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
