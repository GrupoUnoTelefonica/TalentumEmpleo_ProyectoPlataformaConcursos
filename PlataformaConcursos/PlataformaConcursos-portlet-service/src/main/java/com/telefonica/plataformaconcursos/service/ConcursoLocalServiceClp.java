 ...
 * @generated
 */
public class ConcursoLocalServiceClp implements ConcursoLocalService {
    ...
    public ConcursoLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.telefonica.plataformaconcursos.model.Concurso addConcurso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(concurso) });
        } catch (Throwable t) {
        ...
        return (com.telefonica.plataformaconcursos.model.Concurso) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.telefonica.plataformaconcursos.model.Concurso createConcurso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { concursoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.plataformaconcursos.model.Concurso deleteConcurso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { concursoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.plataformaconcursos.model.Concurso fetchConcurso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { concursoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.telefonica.plataformaconcursos.model.Concurso getConcurso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { concursoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.telefonica.plataformaconcursos.model.Concurso> getConcursos(
        ...
        return (java.util.List<com.telefonica.plataformaconcursos.model.Concurso>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.telefonica.plataformaconcursos.model.Concurso> findByEmpresaId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { empresaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
