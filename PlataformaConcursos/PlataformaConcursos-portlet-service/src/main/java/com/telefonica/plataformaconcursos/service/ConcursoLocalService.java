...
/**
 * Provides the local service interface for Concurso. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConcursoLocalServiceUtil
...
public interface ConcursoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ConcursoLocalServiceUtil} to access the concurso local service. Add custom service methods to {@link com.telefonica.plataformaconcursos.service.impl.ConcursoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
